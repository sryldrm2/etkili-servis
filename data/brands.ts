...
export const brands: Brand[] = [
  ...
  { name: 'Hobart', logo: '/brands/hobart.png' },
  { name: 'Fagor', logo: '/brands/fagor.svg' },
  { name: 'Ottoman', logo: '/brands/ottoman.png' },
  { name: 'Himaksan', logo: '/brands/himaksan.png' },
  { name: 'Emeksan', logo: '/brands/emeksan.png' },
  ...
  { name: 'Winterhalter', logo: '/brands/winterhalter.png' },
]
