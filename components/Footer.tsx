    ...
    <footer className="bg-primary-darkest border-t border-white/20 mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Col 3: Service Areas */}
          <div>
            <h4 className="uppercase tracking-wider text-sm font-bold text-primary-lightest mb-4">Hizmet Bölgelerimiz</h4>
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><Link href="/iletisim" className="hover:text-white transition-colors">İstanbul Anadolu Yakası Servisi</Link></li>
              <li><Link href="/iletisim" className="hover:text-white transition-colors">Gebze Endüstriyel Mutfak Tamiri</Link></li>
              <li><Link href="/iletisim" className="hover:text-white transition-colors">Kocaeli Teknik Servis Hizmetleri</Link></li>
              <li><Link href="/iletisim" className="hover:text-white transition-colors">İzmit Endüstriyel Ekipman Servisi</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-200 text-sm">
              <li className="flex items-start space-x-2">
                ...
                <span>Merve Mah. Sait Sok. No:18/A Sancaktepe/İstanbul</span>
              </li>
              ...
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:info@etkiliendustriyelservisi.com" className="hover:text-white transition-colors">
